...
const ThreadRoot = forwardRef<HTMLDivElement, ThreadPrimitiveRootProps>(
  ({ className, ...rest }, ref) => {
    return (
      <ThreadPrimitive.Root
        className={cn("flex h-full flex-col items-center pb-4", className)}
        ref={ref}
        {...rest}
      />
    );
...
const ThreadViewport = forwardRef<HTMLDivElement, ThreadPrimitiveViewportProps>(
  ({ className, ...rest }, ref) => {
    return (
      <ThreadPrimitive.Viewport
        className={cn(
          "flex w-full flex-grow flex-col items-center overflow-y-scroll scroll-smooth px-4 pt-12",
          className,
        )}
        ref={ref}
        {...rest}
