...
Renders all messages. This primitive renders a separate component for each message. The role of the message can be "assistant", "user", "system", or "data".
      ...
      children: [
        {
          ...
          parameters: [
            ...
            },
            {
              name: "DataMessage",
              type: "ComponentType",
              description: "The component to render for data messages.",
            },
          ],
        },
      ],
