...
The RemoteThreadListHookInstanceManager, RemoteThreadListThreadListRuntimeCore, and useRemoteThreadListRuntime have been updated to handle generic types. This means that these classes and functions can now handle a wider range of types, providing more flexibility in their usage. This update does not require any changes in the existing documentation as it is an internal enhancement.