...
- [@ccbkai](https://github.com/ccbkai) for integrating Chrome's `window.ai` with assistant-ui
...
assistant-ui builds on top of [radix-ui](https://www.radix-ui.com/), [tailwindcss](https://tailwindcss.com/), [shadcn-ui](https://ui.shadcn.com/), [Vercel AI SDK](https://sdk.vercel.ai/docs/introduction) and other amazing open-source projects.
